...
public class OnlineOrderItemResourceIntTest {
    ...
    public void createOnlineOrderItem() throws Exception {
        ...
        assertThat(testOnlineOrderItem.getOrderAmount()).isEqualTo(DEFAULT_ORDER_AMOUNT);
    ...
    public void checkOrderAmountIsRequired() throws Exception {
        ...
        // set the field null
        onlineOrderItem.setOrderAmount(null);
    ...
    public void updateOnlineOrderItem() throws Exception {
        ...
        OnlineOrderItem testOnlineOrderItem = onlineOrderItemList.get(onlineOrderItemList.size() - 1);
        assertThat(testOnlineOrderItem.getOrderAmount()).isEqualTo(UPDATED_ORDER_AMOUNT);
